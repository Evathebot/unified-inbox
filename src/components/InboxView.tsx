...
import { ArrowUp, SlidersHorizontal, ChevronRight, X, Plus, Send, Sparkles, Paperclip, Link2, Image, Smile, Mic, Square, Type } from 'lucide-react';
              ...
              {replySent ? (
                        ...
                        {Array.from({ length: 24 }).map((_, i) => (
                          <div
                            ...
                            style={{
                              ...
                              animation: `voice-pulse ${1 + Math.random()}s ease-in-out infinite`,
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center gap-1 mb-2 px-1">
                    <button className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all" title="Format text">
                      <Type size={14} />
                    </button>
                    <button className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all" title="Attach file">
                      <Paperclip size={14} />
                    </button>
                    <button className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all" title="Add link">
                      <Link2 size={14} />
                    </button>
                    <button className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all" title="Emoji">
                      <Smile size={14} />
                    </button>
                    <button className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all" title="Add image">
                      <Image size={14} />
                    </button>
                    <div className="flex-1" />
                    <button
                      onClick={() => {
                        ...
                        const interval = setInterval(() => {
                          setRecordingTime(t => {
                            if (t >= 120) { clearInterval(interval); return t; }
                            return t + 1;
                          });
                        }, 1000);
                      }}
